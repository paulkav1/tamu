...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'applicant.label', default: 'Applicant with Documents')}" />
	...
	<body>
		...
		<div id="show-applicant" class="content scaffold-show" role="main">
			...
			<ol class="property-list applicant">
				...
				<li class="fieldcontain">
					<span id="colloquyId-label" class="property-label"><g:message code="applicant.colloquyId.label" default="Documents" /></span>
						<g:each in="${docs}" status="i" var="doc">		
							<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">								
								<td><g:fieldValue bean="${applicantInstance}" field="doc.docId"/></td>
							</tr>
						</g:each>
				</li>
